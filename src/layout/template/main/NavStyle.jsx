    ...
    <Fragment>
      <header className="sticky top-0 z-50 border-b border-gray-100 bg-white shadow-sm">
        <nav className="relative mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4">
            ...
            {isAuthenticated ? (
              <div className="relative" ref={mobileProfileMenuRef}>
                ...
                >
                  ...
                  <button
                    onClick={handleLogout}
                    className="mt-2 flex w-full items-center justify-center gap-2 rounded-md border-t border-gray-200 bg-white px-3 py-2 text-sm font-medium text-red-500 transition-colors hover:bg-gray-100"
                  >
                    Logout
          ...
          <div
            ref={mobileMenuRef}
            className={`absolute inset-x-0 top-full z-40 block w-full rounded-b-2xl border-t-[0.5px] border-b-2 border-blue-700 bg-white px-6 py-4 transition-all duration-300 ease-out lg:hidden ${
              isMobileMenuOpen
          ...
          >
            ...
            <div className="mt-4 flex flex-col items-center gap-3">
              {/* Universal "Get Started" button for mobile */}
