...
const LoginView = () => {
  ...
  // ✅ পরিবর্তন: এখন আমরা শুধুমাত্র AuthContext থেকে 'loading' স্টেটটি ব্যবহার করছি।
  const { login: authLogin, user, loading } = useContext(AuthContext);

  useEffect(() => {
    // লোডিং শেষ হলে এবং user অবজেক্টটি লোড হয়ে গেলে রিডাইরেক্ট করুন
    if (!loading && user) {
  ...
  // শুধুমাত্র handleLoginSubmit function পরিবর্তন করুন
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        // ✅ Login successful হলে সাথে সাথেই redirect করি
  ...
  // অন্যান্য ফাংশনগুলো আগের মতোই আছে...
  ...
  const renderContent = () => {
    // ✅ সমাধান: এখন আমরা শুধুমাত্র AuthContext থেকে আসা loading স্টেটটি ব্যবহার করছি
    // যদি AuthProvider লোডিং অবস্থায় থাকে, তাহলে একটি লোডিং স্ক্রিন দেখাও।
    if (loading) {
      return (
    ...
    // ... অন্যান্য স্টেপগুলো (1, 2, 3) আগের মতোই থাকবে।
    switch (step) {
      case 1:
        return (
          <div className="p-8">
          ...
          <>
            ...
            >
              ...
              <button
                ...
                disabled={loading} // ✅ পরিবর্তন: এখন এটি AuthProvider থেকে loading স্টেট ব্যবহার করে
              >
                {/* ✅ পরিবর্তন: loading স্টেট সত্য হলে স্পিনার দেখাও */}
                {loading ? (
