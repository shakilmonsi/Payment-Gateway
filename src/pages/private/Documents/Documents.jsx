...
import UpdateDocumentsModal from "./modal/UpdateDocumentsModal";
      ...
      <div className="mx-auto max-w-full px-4 pt-6 sm:px-20">
        ...
        <div className="mb-6 flex flex-col gap-4 border-b border-stone-300 py-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="relative w-full lg:w-52">
            ...
            {isDropdownOpen && (
              <ul className="absolute z-10 mt-2 max-h-60 w-full overflow-y-auto rounded-[8px] bg-white shadow-[12px_12px_24px_0_rgba(18,118,249,0.16)]">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-['Roboto'] text-sm font-normal text-orange-500">
                        {calculateDaysLeft(doc.expiryDate, doc.expiryCount)}
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-4 border-t border-gray-200 pt-4">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                  ...
                  <div className="border-blue-400/20 sm:col-span-2">
                    ...
                    <dd className="mt-1 text-sm break-all text-blue-600 underline hover:text-blue-800">
                      <a
