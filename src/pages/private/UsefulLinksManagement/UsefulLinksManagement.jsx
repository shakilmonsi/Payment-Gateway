...
const UsefulLinksManagement = () => {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center bg-white p-4 sm:p-4 md:p-8 lg:p-10">
      <Toaster position="top-center" reverseOrder={false} />

      {/* Search Bar */}
      <div className="mt-14 flex w-full max-w-full flex-col gap-6 px-2 sm:mt-6 sm:px-6 md:mt-0 md:px-16 lg:px-24">
        <div className="flex w-full justify-start border-b border-stone-300 px-1 py-3 sm:px-3 lg:px-6">
      ...
      {/* Add Link */}
      <div className="mt-6 flex w-full max-w-full flex-col gap-6 px-2 sm:px-6 md:px-16 lg:px-24">
