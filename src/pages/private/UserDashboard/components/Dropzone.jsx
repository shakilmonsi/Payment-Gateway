  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="mb-6 font-['Roboto'] text-xl font-semibold text-black sm:mb-8 md:mb-10">
          Upload Document
        </h2>
        ...
        <div className="mb-6 flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 hover:border-blue-500 sm:mb-8 md:mb-10">
          <div className="flex w-full flex-col items-center justify-center">
            ...
            >
              ...
              >
                <FiUpload className="mb-7 h-10 w-10 text-black" />
                <p className="font-['Segoe_UI'] text-xl leading-normal font-semibold text-neutral-800">
                  Drag & drop files here
                </p>
                <p className="my-5 font-['Segoe_UI'] text-base leading-normal font-normal text-neutral-600">
                  or
                </p>
              </div>
              <button
        ...
        <input
          ...
          className="mb-4 w-full rounded border border-gray-300 px-3 py-2 text-sm text-black"
        />
        ...
        <div>
          ...
          <div className="mb-4 grid max-h-[180px] grid-cols-2 gap-4 overflow-y-auto text-sm text-black">
