    ...
    <div className="mx-auto min-h-screen max-w-7xl p-6">
      ...
      <div className="mb-8">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {/* Essential cookies */}
          <div className="rounded-lg bg-white p-8 border border-blue-100 shadow-xl">
            <div className="mb-6 flex items-center gap-3">
      ...
      <div className="space-y-8">
        ...
        <div className="rounded-lg bg-white p-8 border border-blue-100 shadow-xl">
          <div className="mb-6 flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900">
              Cookie Banner Text (for your developer to add)
            </h2>
          </div>

          <div className="rounded-r-lg border-l-4 border-indigo-500 bg-gray-50 p-6">
            <h3 className="mb-3 font-semibold text-gray-900">Banner Text:</h3>
