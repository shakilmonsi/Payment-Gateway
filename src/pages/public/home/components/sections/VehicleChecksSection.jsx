...
const VehicleChecksSection = () => {
  const cardsData = [
    ...
    },
    {
      ...
      description:
        "Securely store and manage all your important  documents with automatic expiry reminders.",
      listItems: [
  ...
  return (
    <div
      id="features"
      className="flex font-['Roboto'] w-full flex-col items-center justify-center gap-10 bg-neutral-600/5 px-4 py-24 sm:px-12 md:px-14 lg:px-20"
    >
