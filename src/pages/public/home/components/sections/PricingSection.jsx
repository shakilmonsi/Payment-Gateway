...
// ✅ createGenericSubscription ইম্পোর্ট করা হলো
...
const PricingSection = () => {
  ...
  // ✅ createGenericSubscription useAuth থেকে আনা হলো

  const { user, isAuthenticated, createGenericSubscription } = useAuth();
  ...
  const handleSubscriptionAction = async (plan, paymentMethodId, isTrial) => {
    ...
    try {
      console.log(
        "📤 [PRICING] Calling createGenericSubscription (Postman Logic) with:",

        { paymentMethodId, priceId: plan.priceId, isTrial },
      );

      // ✅ নতুন ফাংশন ব্যবহার করা হলো: এটি Postman-এর সম্পূর্ণ রিকোয়েস্টটি হ্যান্ডেল করবে।
      ...
      if (result && result.success) {
        // Handle redirect case (যদি API থেকে redirect URL আসে)
