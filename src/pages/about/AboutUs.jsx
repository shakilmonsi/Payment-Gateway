...
export default function AboutUs() {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-7xl justify-center px-3 py-6 sm:px-4 md:px-6">
      <div className="relative w-full max-w-7xl">
        <div className="rounded-2xl border-blue-100 bg-white p-4 sm:p-6 md:p-8">
          {/* Header */}
          <div className="mb-6 flex items-center gap-4">
            <div className="w-full">
              ...
              <div className="flex w-full flex-col gap-6 md:flex-row md:items-center md:justify-between">
                ...
                <div>
                  <img src={carImage} alt="Taxi car" className="rounded-2xl" />
                </div>
              </div>
            </div>
          </div>
